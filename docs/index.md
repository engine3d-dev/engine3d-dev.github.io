...
Engine3D is a game engine that is open source. Focusing on the inner workings of being portable, flexible, and giving students the foundation of working on an actual game engine. Working with consideration of cross-platform support such as Windows, Linux, and Mac.

🚧 NOTE: Engine3D is still early in it's development. Does not have what an engine needs to develop a game. 🚧
 
Design Philosophy behind Engine3D:
